...
<configuration>
  ...
  <appSettings>
    ...
    <add key="UnobtrusiveJavaScriptEnabled" value="true" />
	  <add key="UserPath" value="C:\Users\869965\source\repos\Loan Management\Loan Management\Uploads\"/>
  </appSettings>
  <system.web>
    <compilation debug="true" targetFramework="4.7.2" />
    <httpRuntime targetFramework="4.7.2" />
  <authentication mode="Forms">
	 <forms loginUrl="Customer/Login"></forms>
...
<connectionStrings>
    <add name="CustomerContext"  connectionString="server=127.0.0.1; port=5432; user id=postgres; password=Test123#; database=Customer" providerName="Npgsql" />
</connectionStrings>
<system.data>
    <DbProviderFactories>     
